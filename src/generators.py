...
def card_number_generator(start: int, end: int) -> Generator[str, None, None]:
    """Генерирует номера карт в диапазоне от 0000 0000 0000 0001 до 9999 9999 9999 9999"""
...
usd_transactions = filter_by_currency(transaction_exemple, "USD")
...
# Возвращает описание каждой операции по очереди
description_description = transaction_descriptions(transaction_exemple)


for _ in range(5):
    print(next(description_description))


# Генерирует номера карт в определенном диапазоне
